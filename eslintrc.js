...
module.exports = {
    ...
    plugins: [
      ...
      '@react-native-community/eslint-plugin-a11y', // React Native specific a11y rules
      'prettier',
    ],
    parserOptions: {
      ecmaFeatures: {
    ...
    rules: {
      ...
      '@react-native-community/platform-colors': 'off',
      '@react-native-community/no-haste-imports': 'error',
