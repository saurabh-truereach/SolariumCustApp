  ...
  describe('Storage Helpers', () => {
    ...
    describe('setStorageItem', () => {
      ...
      it('should handle storage errors', async () => {
        ...
        await expect(setStorageItem('test-key', 'data')).rejects.toThrow('Storage failed');
      });
    });
    ...
    describe('removeStorageItem', () => {
      ...
      it('should handle removal errors', async () => {
        ...
        await expect(removeStorageItem('test-key')).rejects.toThrow('Remove failed');
      });
    });
    ...
    describe('getStorageInfo', () => {
      ...
      it('should handle storage unavailability', async () => {
        mockEncryptedStorage.setItem.mockRejectedValue(new Error('Storage failed'));
    ...
    describe('API Cache', () => {
      ...
      describe('getApiCache', () => {
        it('should return cached data when not expired', async () => {
          ...
          mockEncryptedStorage.getItem.mockResolvedValue(JSON.stringify(cacheData));
        ...
        it('should return null for expired cache', async () => {
          ...
          expect(result).toBeNull();
          expect(mockEncryptedStorage.removeItem).toHaveBeenCalledWith('cache-key');
        });
